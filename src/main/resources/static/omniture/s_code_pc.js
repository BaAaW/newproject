var s_account="cpic-out of service"
var s_sensor=""
var s_locHost=window.location.host
if(s_locHost == "" || s_locHost.indexOf("sitmember") >= 0 || s_locHost.indexOf("test") >= 0 || s_locHost.indexOf("wwwsit") >= 0 || s_locHost.indexOf("onesit") >= 0 || s_locHost.indexOf("msbcdsit") >= 0|| s_locHost.indexOf("znkfsit") >= 0) {
	s_sensor="cdmsensor.cpic.com.cn"
	s_account="cpic-out of service"
} 
...
s.linkInternalFilters="javascript:,ecpic.com.cn,cpic.com.cn"
...
/* Track queryed product names, temporary codes */
var lowerCaseUrl=document.location.href.toLowerCase();
	if(lowerCaseUrl.indexOf("policyschema") >=0 ) {
		setTimeout(function() {
			var productName=null;
			if(lowerCaseUrl.indexOf("automobileschema") >= 0) {
				if(document.getElementById("productName") != null)
					productName=document.getElementById("productName").innerHTML;
			}
			else {
				if(document.getElementById("basicName") != null)
					productName=document.getElementById("basicName").innerHTML;
				if(document.getElementById("mainclassName") != null)
					productName=document.getElementById("mainclassName").innerHTML;
			}
			if(productName!=null && productName!="") {
				var s=s_gi(s_account);
				s.linkTrackVars='prop49';
				s.prop49=productName;
				s.eVar47=productName;
				s.tl(this,'o','BDCX');
			}
			else
...
function s_doPlugins(s) {
	...
	if(s.eVar48 != null)
		s.eVar48 = s.eVar47 + " >> " + s.eVar48;
	
	 /* Set External Campaign Variable */
		if(!s.campaign){
		 s.campaign = s.Util.getQueryParam('cmpid');
		 if(s.campaign!=''){
		 s.eVar31 = "External Campaign";
		 }
		}
		var cmpidStr;
		var othStr;
		cmpidStr= s.Util.getQueryParam('cmpid');
		othStr= s.Util.getQueryParam('otherSource');

	   if(cmpidStr||othStr){
		   	   var exdate=new Date();
               exdate.setTime(exdate.getTime()+7*24*3600*1000);
	   	if(othStr){
               document.cookie="cmpIdCookie"+ "=" +othStr+";"+"expires="+exdate.toGMTString()+";path=/;";
			   document.cookie="cmpId"+ "=" +othStr+";"+"expires="+exdate.toGMTString()+";path=/;";
		}else if(cmpidStr){
			  var cmpidStrID;
			if(cmpidStr.substring(0,3)=="nim"){
				cmpidStrID="163";
			}
			   document.cookie="cmpIdCookie"+ "=" +cmpidStr+";"+"expires="+exdate.toGMTString()+";path=/;";
			   document.cookie="cmpId"+ "=" +cmpidStrID+";"+"expires="+exdate.toGMTString()+";path=/;";
		}
	   	   }
	/* Set External Cooperation */
		if(!s.eVar20)
	{
			var str1= s.Util.getQueryParam('otherSource');
			var str2=s.Util.getQueryParam('source');
			if(str1){
				s.eVar20=str1;
			}
			if(str2 && !str1){
	...
	/* Set Cookie To Store otherSource */
	/* Set Cookie To Store otherSource */
if(s.Util.getQueryParam('cmpid')){
		       var str1=s.Util.getQueryParam('cmpid');
			   var str4;
	   	   		   if(str1.substring(0,3)=="nim"){
		       str4="163";
	   }else if(str1.substring(0,4)=="shad"){
	   		   str4="563";
	   }
	   else{
	   	   switch (str1){
		...
		case "i07_ci123_011":
			str4="393";
		break;
		case "i07_netease_001":
			str4="394";
		break;
		case "i07_dianxin_001":
			str4="395";
		break;
		case "i07_dianxin_002":
			str4="396";
		break;
		case "i07_weather_001":
			str4="397";
		break;
		case "i07_juxiao_001":
			str4="398";
		break;
        case "i07_dianxin_003":
			str4="404";
		break;
		 case "i03_dxszlyh_000001":
			str4="750";
		break;
		case "i03_dxszlyh_000002":
			str4="751";
		break;
		case "i03_dxszlyh_000003":
			str4="752";
		break;
		case "i03_dxszlyh_000004":
			str4="753";
		break;
		case "i03_dxszlyh_000005":
			str4="754";
		break;
		default :
		break;
	   		  ...
	   		  s.eVar20=str4;
	   		   var exdate=new Date();
               exdate.setTime(exdate.getTime()+7*24*3600*1000);
               document.cookie="othSourceCookie"+ "=" +str4+";"+"expires="+exdate.toGMTString()+";path=/;";
	 }
	/* Set Internal Promotion Variable */
	 s.eVar2 = s.Util.getQueryParam('intcmp');
	   if(s.eVar2!='')
	{
		s.eVar31 = "Internal Promotions";
	}
	
		/* Set navigation recommended  Variable */
		s.eVar45 = s.Util.getQueryParam('navirec');
		if (s.eVar45!='')
			{
		s.eVar31 = "Navigation";
		}
		/* Set homepage hit  Variable */
		
		if (!s.prop55)
		{
			s.prop55 = s.Util.getQueryParam('hit');
		} 
		s.eVar40 = s.prop55;
	
     /* Set homepage hotsale  Variable */
	 s.eVar43 = s.Util.getQueryParam('hotsale');
		if(s.eVar43!='')
	{
		s.eVar31 = "Homepage";}
		/* Set  product recommendation  Variable */
		s.eVar42 = s.Util.getQueryParam('prorec');
		if(s.eVar42!='')
	{
		s.eVar31 = "Products Recommendation";
		}
	/* New & Repeat Visitors */
		s.prop11=s.getNewRepeat();
		s.eVar11=s.prop11;
	/* Time Parting */
		s.prop12=s.getTimeParting('h','8'); // Set hour 
		s.prop13=s.getTimeParting('d','8'); // Set day 
		s.eVar12=s.prop12;
		s.eVar13=s.prop13;
	/* Page Functionality */
	 if(!s.prop4)
	...
	/* Automatic Values */
		...
		s.eVar1=s.pageName;
		var prop7=document.location.href;
		s.prop7=prop7.substring(0,100);
		if(s.eVar7)
			s.transactionID=s.eVar7

		s.eVar26=Date.parse(new Date())/1000;
...
s.visitorNamespace="cpic"
s.trackingServer="cpic.sc.omtrdc.net"
/*
